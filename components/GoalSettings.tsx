    ...
    <div className={`glass rounded-[32px] shadow-xl p-5 sm:p-8 max-w-2xl mx-auto border-2 border-white animate-fade-in`}>
      ...
      <div className="space-y-5">
        ...
        <button 
          ...
          className="w-full py-5 bg-gradient-primary text-white rounded-2xl font-extrabold hover:shadow-xl hover:shadow-brand-blue/30 transition-all text-lg sm:text-xl hover-scale mt-2 flex items-center justify-center"
        >
